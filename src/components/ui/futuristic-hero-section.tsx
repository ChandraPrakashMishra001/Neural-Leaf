...
export const AuroraHero = () => {
  ...
  return (
    ...
    >
      <div className="relative z-20 flex flex-col items-start px-8 md:px-24 w-full max-w-7xl mx-auto h-full justify-center pb-32">
        ...
        <h1 className="max-w-4xl bg-gradient-to-br from-white to-neutral-400 bg-clip-text text-left text-4xl font-medium leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight pb-2">
